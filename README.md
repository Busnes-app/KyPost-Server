...
- PGP recovery copies stored as ciphertext, downloadable backups checked before creation completes, and browser-local recovery drills. Complete-ring export, drills and matching-backup restore preserve historical keys; restoration confirms the stored result before unlocking. Conversion, older-backup merge and recovery uploads remain gated.
