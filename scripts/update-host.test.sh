...
if [[ "$1 ${2:-}" == "compose version" || "$1 ${2:-}" == "buildx version" ]]; then
  ...
  echo "ghcr.io/busnes-app/kypost-server:stable"
  ...
  echo "ghcr.io/busnes-app/kypost-server@sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"
