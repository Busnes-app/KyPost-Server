...
var publicRoutes = map[string]string{
	...
	"POST /api/notifications/review-pairing": "Play reviewer has no session; handler is disabled by default and verifies only the operator-named demo account or prefix",
