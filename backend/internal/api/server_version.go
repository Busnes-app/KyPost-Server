...
var serverReleasesURL = "https://api.github.com/repos/Busnes-app/KyPost-Server/releases"
	...
	return s.sendAdminNotice(
		...
		fmt.Sprintf(
			"This install is running KyPost-Server %s. Version %s has been released.\n\n"+
				...
				"Release notes: https://github.com/Busnes-app/KyPost-Server/releases/tag/v%s\n\n"+
