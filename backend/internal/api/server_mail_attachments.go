...
// Both endpoints serve the message's outer MIME parts and nothing else, so each
// request costs exactly one IMAP fetch. A PGP/MIME message's outer part is the
